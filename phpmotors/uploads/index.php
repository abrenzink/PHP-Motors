...
switch ($action) {
    case 'upload':
        ...
        if($imageCheck){
            $message = '<p class="message">An image by that name already exists.</p>';
        ...
        if ($result) {
            $message = '<p class="okMessage">The upload succeeded.</p>';
        } else {
    ...
    case 'delete':
        ...
        if ($remove) {
            $message = "<p class='okMessage'>$filename was successfully deleted.</p>";
        } else {
